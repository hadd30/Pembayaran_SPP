...
<div>
    <div>
        <h5 class="mb-3 text-xl font-semibold">Halaman Edit Data SPP</h5>
    ...
    <form method="post" action="?url=proses-edit-spp&id_spp=<?= $id_spp; ?>" class="space-y-4">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="nominal" id="nominal" maxlength="13" required value="<?= $data['nominal'] ?>" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-green-500" />
        </div>
